...
class PolicyValueNetwork(Chain):
    def __init__(self):
        ...
        with self.init_scope():
            ...
            # value network
            self.norm13_v = L.BatchNormalization(MOVE_DIRECTION_LABEL_NUM)
            self.norm14_v = L.BatchNormalization(fcl)
    ...
    def __call__(self, x):
        ...
        # value network
        h13_v = F.relu(self.norm13_v(self.l13_v(h12)))
        h14_v = F.relu(self.norm14_v(self.l14_v(h13_v)))
